...
export default function Hero() {
  ...
  return (
    <motion.div
      initial="hidden"
      animate="visible"
      className="bg-[#FDF9F0] border-b-3 border-[#1a1a1a] min-h-[calc(100vh-80px)] 2xl:min-h-[800px] max-h-[1000px] flex items-center py-12 md:py-16 relative overflow-hidden"
    >
