...
export default function Hero() {
  ...
  return (
    <motion.div
      initial="hidden"
      animate="visible"
      className="bg-[#FDF9F0] border-b-3 border-[#1a1a1a] min-h-[calc(100vh-80px)] lg:max-h-[800px] xl:max-h-[850px] flex items-center py-12 md:py-16 relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-28 xl:gap-32 relative z-10">
        ...
        <motion.div variants={staggerContainer} className="lg:w-1/2 space-y-4">
          ...
          >
            <span className="block sm:whitespace-nowrap">INSTALL PACKAGE.</span>
            <motion.span
              variants={fadeInUp}
              className="text-[#FF4D00] block sm:whitespace-nowrap"
            >
              EMBED TOKEN.
            </motion.span>
            <span className="block sm:whitespace-nowrap">GO LIVE.</span>
          </motion.h1>
        ...
        <motion.div variants={fadeInUp} className="lg:w-1/2 flex justify-center relative">
          <div className="relative p-3 bg-white border-3 border-[#1a1a1a] shadow-neo-lg max-w-[505px]">
